...
const tabMenu = document.querySelector('.btn-container');
...
const CategoryButtons = tabMenu.querySelectorAll('button');

CategoryButtons.forEach(button => {
  button.addEventListener('click', () => {
    const category = button.textContent;
    const filteredMenu = category === 'All' ? menu : filterCategory(category);
